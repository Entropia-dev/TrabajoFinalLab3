...
namespace Dao
{
     public class DaoClientes
    {
        ...
        public Clientes  getProducto(Clientes pro)
        {
            ...
            pro.set_Dni(tabla.Rows[0][4].ToString());
            pro.set_Usuario_Cli(tabla.Rows[0][5].ToString());
            pro.set_Metodo_captacion(tabla.Rows[0][6].ToString());
            pro.set_Direccion(tabla.Rows[0][7].ToString());
            pro.set_Fecha_Nac(tabla.Rows[0][8].ToString());
            pro.set_sexo(tabla.Rows[0][9].ToString());
            return pro;
        }
        ...
        private void ArmarParametrosClienteAgregar(ref SqlCommand Comando, Clientes pro)
        {
            ...
            SqlParametros = Comando.Parameters.Add("@fecha_nac", SqlDbType.VarChar);
            SqlParametros.Value = pro.get_Fecha_Nac();
            SqlParametros = Comando.Parameters.Add("@metodo_cap", SqlDbType.VarChar);
            SqlParametros.Value = pro.get_Metodo_captacion();
